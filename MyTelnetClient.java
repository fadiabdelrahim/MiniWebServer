...
public class MyTelnetClient{
  public static void main (String args[]) {
    ...
    System.out.println("Fadi Abdelrahims's MyTelnet Client, 1.0.\n");
    ...
    try {
      ...
      do {
        ...
        if (dataToSend.indexOf("stop") < 0){ // if stop is typed it will stop
	  toServer.println(dataToSend);	// send lines of data from console 
	  toServer.flush();
	}
